<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="StoreSubjects_Excel.aspx.cs" Inherits="Default2" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="pagetitle">Subject Master Entry</h2>
       ...
       <table style="width: 70%;" align="center">
            <tr >
                <td align="right">
                    Subject Code :</td>
                 <td>
                     <asp:TextBox ID="txt_scode" runat="server"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr >
                <td align="right">
                    Department Code :</td>
                 <td>
                     <asp:DropDownList ID="drp_scode" runat="server">
                     </asp:DropDownList>
                </td>
            </tr>
